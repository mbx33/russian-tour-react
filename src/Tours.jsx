    ...
    <div className="tourInfo" style={{ color: "white", marginTop: "4em" }}>
      ...
      <section className="tourMainInfoContainer">
        <div>
          ...
          >
            These tours have been created with you in mind. They have everything
            you need included, especially if this is your first time visiting St
            Petersburg. We have picked the must see places & things to do. I
            know your time and money is important when choosing how to use it. I
            want you to enjoy your time here. I want to take your stress away so
            you can focus on what you want to do, and that is relax. The
            memories you make here will be priceless.
          </p>
        </div>
      </section>
            ...
            >
              ...
              <section>
                ...
                <ol className="listText">
                  <li>
                    Airport Pickup |{" "}
                    <MdLocalAirport className="includedIcons" />
                  </li>
                  ...
                  <li>
                    Transportation |{" "}
                    <MdOutlineAirportShuttle className="includedIcons" />
                  </li>
                  <li>
      ...
      <div>
        <p
          style={{ marginLeft: "16em", fontSize: "18px", fontFamily: "roboto" }}
        >
          {" "}
      ...
      <div className="mapContainer">
        <div className="leftContainer">
          ...
          <p>
            ...
            molestiae corrupti architecto incidunt ipsam quis quibusdam amet
            dicta modi. At aliquam, illo dolore porro harum illum doloribus
            dolorum vitae eos.
          </p>
        </div>
        <iframe
